(function() {
  ...
  angular
    .module('adminApp')
    .controller('SourceStationCtrl', SourceStationCtrl);

  SourceStationCtrl.$inject = ['$scope', 'Config', '$state', 'Actions', '$q'];

  function SourceStationCtrl($scope, Config, $state, Actions, $q) {
